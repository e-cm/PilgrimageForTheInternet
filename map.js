            ...
            google.maps.event.addDomListener(logo, 'click', function() {
                if (testCircle.getBounds().contains(currentPosition.getPosition())) {
                    ...
                    google.maps.event.addDomListener(continueButton, 'click', function() {
                        ...
                        document.getElementById(popUps[popIndex]).style.zIndex = "-100";
                        document.getElementById(popUpsBoxes[popIndex]).style.display = "none";
                        document.getElementById(popUpsBoxes[popIndex]).style.zIndex = "-100";
                    ...
                    document.getElementById('radius').style.zIndex = "100";
                    document.getElementById("r").style.display = "inline";
                    document.getElementById("r").style.zIndex = "100";
