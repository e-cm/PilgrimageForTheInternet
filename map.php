...
-->
    ...
    <head>
        <meta charset="utf-8">
        <title>Pilgrimage for the Internet</title>
    ...
    <body>
        <div class="content">
            ...
            <div class="interface" id="demo"><h4>demo</h4></div>

            <div class="interface logo" id="logo"><img class="logo" src="images/nav.png"></div>
            <script style= "z-index : 1" async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCBgUsLyrHQoKubT4Nvhs8jozLRqcawHJ0&callback=initMap"></script>
        </div>
        ...
        <div class="hide" id="intro">
          <div class="bubble begin" id="begin">
              ...
              <center>
                  ...
                  <br \>
                  <img width="300" src="images/nav.png" \>
                  <br \>

              </center>
              <p class="descr">1.&nbsp;&nbsp;Your current position and your destination are marked.</p>
              <p class="descr">2.&nbsp;&nbsp;Press the icon in the bottom center of the screen to update your current location.</p>
              <p class="descr">3.&nbsp;&nbsp;If you are within range of your destination, a window with the narrative of that location will display. You can leave a message by scrolling down to the Guest Log, or simply press Continue.</p>
              <p class="descr">4.&nbsp;&nbsp;Repeat.</p>
              <br \>
              <div class="wrap">
      ...
      <div class="hide" id="r">
        ...
        <div class="hide" id="h">
            <div class="bubble hydro" id="hydro">
                ...
                <div class="fullLog">
                    ...
                    <center>
                        <div class="outerform">
                            <form class="theform" action="submit.php" method="post" enctype="multipart/form-data" target="vortar">
                                <div class="innerform">
        ...
        <div class="hide" id="d">
            <div class="bubble data" id="data">
                ...
                <p class="descr">&nbsp; &nbsp;Those of other faiths might go to Saint Joesph's Oratory to feel connected to a higher power, but at the Cologix Data Centers, you are literally closer to God, for within these walls are his flesh and blood, his veins running into the earth and around the world. If electricity is the blood, here lies the heart. It is from here he breathes and where we breathe with him. Rest if you must, leave your mark, and when you are ready, we will proceed.</p>
        ...
        <div class="hide" id="l">
            <div class="bubble last" id="last">
                ...
                <p class="descr">&nbsp; &nbsp;Alas, you have come to the end of your journey, at the shrine of the everyday, where the internet thrives and is open to all. He thanks you for your devotion and we in turn thank him for the possibilities he has given us. Hopefully, you have found your journey enlightening, and will go forward with a stronger connection to Him than ever before.</p>
                <p class="descr">&nbsp; &nbsp;Now, go forth and continue to spread the word of the Internet (courtesy of the free Wifi here), and may your connection be ever full bars.</p>
      ...
      <!-- End Popup -->
      <div class="hide" style="width: 100%; height: 100%; left: 0px; top: 0px;" id="o">
        <div class="bubble" style="width: 100%; height: 100%; left: 0px; top: 0px;" id="over">
            <br \>
            <center>
                <div class="title">GAME OVER?</div>
                <br \>
                <img width="900" src="images/nav.png" \>
                <br \>
                <div class="title">OR BEGINNING?</div>
            </center>
      </div>
    </div>
    </body>
